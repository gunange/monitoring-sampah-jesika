			...
			<div class="card">
				<div class="card-header flex justify-between">
					<div class="flex-none flex items-center">
						<h6><i class="pi pi-sparkles" /> <span>Logs Report</span></h6>
					</div>
				</div>
				<div class="card-body">
...
<script>
	...
	import { MainData } from "@/components/dashboard/petugas/cruds/save-logs/controller";
	import Cruds from "@/components/dashboard/petugas/cruds/save-logs/views/index.vue";

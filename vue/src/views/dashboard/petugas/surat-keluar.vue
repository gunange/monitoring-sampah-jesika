					...
					>
						...
						<template #expand="item">
							<div class="p-4 text-sm bg-gray-50 border border-gray-200 rounded-md space-y-2">
								<div>
									<p class="mb-1 text-primary font-semibold">Perihal Surat:</p>
...
<script>
	...
	import { MainData } from "@/components/dashboard/camat/cruds/surat-keluar/controller";
	import Cruds from "@/components/dashboard/camat/cruds/surat-keluar/views/index.vue";

			...
			<div class="card">
				<div class="card-header flex justify-between">
					<div class="flex-none flex items-center">
						<h6><i class="pi pi-sparkles" /> <span>Staf Setting</span></h6>
					</div>
...
<script>
	...
	import { MainData } from "@/components/dashboard/admin/cruds/staf/controller";
	import Cruds from "@/components/dashboard/admin/cruds/staf/views/index.vue";

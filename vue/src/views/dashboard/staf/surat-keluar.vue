			...
			<div class="card">
				<div class="card-header flex justify-between">
					<div class="flex-none flex items-center">
						<h6><i class="pi pi-sparkles" /> <span>Surat Keluar</span></h6>
					</div>
									...
									:model="[
										{
											...
											severity: 'success',
											command: () => $refs.ref_cruds.open('up', item),
										},
										{
											label: 'Delete',
											icon: 'pi pi-trash',
										...
										},
										{
											...
											icon: 'pi pi-upload',
											severity: 'info',
											command: () => $refs.ref_cruds.open('upload', item),
										},
									]"
								>
...
<script>
	...
	import { MainData } from "@/components/dashboard/staf/cruds/surat-keluar/controller";
	import Cruds from "@/components/dashboard/staf/cruds/surat-keluar/views/index.vue";
